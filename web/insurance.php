...
<div class="team">
	<div class="container">
		<h3 class="heading-agileinfo">INSURANCE<span>Our Panel of Insurance Companies</span></h3>
	
	<center>
    <br><br><br>
    
      <img id="myImg" src="images/Etiqa.png" alt="Etiqa Insurance" width="300" height="200">

      <img id="myImg" src="images/etiqa1.png" alt="Etiqa Takaful" width="300" height="200">

      <img id="myImg" src="images/Hong.png" alt="Etiqa Takaful" width="300" height="200">

      <img id="myImg" src="images/takaful.jpg" alt="Etiqa Takaful" width="300" height="200">

      <img id="myImg" src="images/zurich.png" alt="Etiqa Takaful" width="300" height="200">

      <img id="myImg" src="images/aia.png" alt="Etiqa Takaful" width="300" height="200">

      <img id="myImg" src="images/ambank.jpg" alt="Etiqa Takaful" width="300" height="200">

      <img id="myImg" src="images/mi.jpg" alt="Etiqa Takaful" width="300" height="200">

      <img id="myImg" src="images/tokio.jpg" alt="Etiqa Takaful" width="300" height="200">
</center>	
<!-- The Modal -->
