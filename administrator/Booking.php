...
<div class="container">
<a href="#add" data-toggle="modal"><button type='button' class='btn btn-success btn-sm'><span class='glyphicon glyphicon-plus' aria-hidden='true'></span> Appointment</button></a><br><br>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="PatientName" name="PatientName" value="<?php echo $user_name; ?>" placeholder="Patient Name" required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="email" name="email" value="<?php echo $user_email; ?>" placeholder="Email Address" required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="age" name="age" value="<?php echo $user_age; ?>" placeholder="Age" required autofocus>
                                </div>
                            </div>
                            <br><br>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="datepicker1" name="datepicker1" value="<?php echo $user_gender; ?>" placeholder="Date" onfocus="this.value = '<?php echo $user_gender; ?>' " onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" autofocus required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="gender" name="gender" value="<?php echo $user_time; ?>" placeholder="Gender" required autofocus>
                                </div>
                            </div>
                            <br><br>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="timepicker" name="timepicker" value="<?php echo $user_date; ?>" placeholder="Time" required autofocus>
                                </div>
                            </div>
                            <br><br>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="department" name="department" value="<?php echo $user_department; ?>" placeholder="Department" required autofocus>
                                </div>
                            </div>
                        </div>
                        <br><br>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary" name="update_appointment"><span class="glyphicon glyphicon-edit"></span> Edit</button>
                            <button type="button" class="btn btn-warning" data-dismiss="modal"><span class="glyphicon glyphicon-remove-circle"></span> Cancel</button>
                        </div>
                    </div>
                </div>
          ...
          <strong>Username</strong> Not Found.
                        ...
                        if(isset($_POST['update_appointment'])){
                            ...
                            $sql = "UPDATE appointment SET 
                                ...
                                datepicker1='$user_date',
                                timepicker='$user_time'
