...
<article>
<center><h2>All User Feedback</h2></center><br><br>
 <div class="container">
                    ...
                    <!--<div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="datepicker1" name="datepicker1" value="<?php echo $user_gender; ?>" placeholder="Date" required autofocus>
                                </div>
                            </div>
                        ...
                        if(isset($_POST['update_appointment'])){
                         ...
                         if(isset($_POST['delete'])){
                            ...
                            if ($mysqli->query($sql) === TRUE) {
                                ...
                                if ($mysqli->query($sql) === TRUE) {
                                    $sql = "DELETE FROM feedback WHERE id='$delete_id' ";
                                    echo '<script>window.location.href="user_feedback.php"</script>';
                                } else {
